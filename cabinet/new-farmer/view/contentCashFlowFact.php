...
<div class="box-bodyn">
    <div class="non-semantic-protector">
        <h1 class="ribbon">
            <strong class="ribbon-content">Plan/Fact Cash Flow</strong>
        </h1>
    </div>
    <div class="rown">
                    ...
                    <tr>
                        ...
                        <? foreach ($date['budget']['month_active'] as $month=>$true){?>
                            ...
                            <?if($table['array'] != 'budget_crop_name'){?>
                                ...
                                <td class="ov_table"><?echo number_format($date['budget'][$table['array'].'_month'][$month]-$date['budget']['month_fact_'.$table['array']][$month]);?></td>
                            <?}?>
                        ...
                        <? foreach ($date['budget']['plane_revenues_month_crop'] as $id_crop=>$revenues){?>
                            <tr>
                                ...
                                <? foreach ($date['budget']['month_active'] as $month=>$true){?>
                                    ...
                                    <td class="ov_table"><?=number_format($revenues[$month]-$date['budget']['month_crop_fact_revenue'][$month][$id_crop]); ?></td>
                                <?}?>
                            </tr>
                        <?}
                    }?>
