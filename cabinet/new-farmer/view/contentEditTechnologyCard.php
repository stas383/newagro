...
<table class="table">
    ...
    <?php foreach ($date['TC']['new_action'] as $action){?>
        <tr>
            <td style="width: 10%"><? if($_COOKIE['lang']=='ua'){echo $date['lib'][$action['action_action_type_id']]['name_ua'];}elseif($_COOKIE['lang']=='gb'){echo $date['lib'][$action['action_action_type_id']]['name_en'];}?></td>
            ...
            <td>
                ...
                if(unserialize($action['action_machines'])!=false) foreach(unserialize($action['action_machines']) as $action_machines){
                    ...
                    echo $list_equipment=' + '.substr($list_equipment, 0, -2).', Паливо:'.$action_machines['fuel'].'л/га <br>';
                }?>
            </td>
            <td>
                <?
...
<div id="Choose_equipment" class="modal fade">
    <div class="modal-dialog modal-lg">
            <div class="modal-content wt">
                <div class="box-bodyn">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <span class="box-title">Картка вибору с/г машин та обладнання</span>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
